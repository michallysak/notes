...
public interface UserMapper {
    @Mapping(target = "email", expression = "java(pl.michallysak.notes.common.Email.of(request.getEmail()))")
    @Mapping(target = "password", expression = "java(pl.michallysak.notes.auth.model.Password.of(request.getPassword()))")
