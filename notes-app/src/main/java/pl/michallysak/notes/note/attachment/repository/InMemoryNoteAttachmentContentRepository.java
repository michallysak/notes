...
public class InMemoryNoteAttachmentContentRepository implements NoteAttachmentContentRepository {
  ...
  @Override
  public void saveAttachmentContent(UUID attachmentId, NoteAttachmentContentValue attachmentContent) {
    attachmentContents.put(attachmentId, attachmentContent);
  }

  @Override
  public Optional<NoteAttachmentContentValue> findAttachmentContentByAttachmentId(UUID attachmentId) {
