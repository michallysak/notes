...
public class UserTestUtils {
  ...
  public static EmailPasswordCreateUser.EmailPasswordCreateUserBuilder
      createEmailPasswordCreateUserBuilder() {
    return EmailPasswordCreateUser.builder().email(DEFAULT_EMAIL).password(PASSWORD);
  }
}
